...
describe("/api/genres", () => {
  ...
  describe("GET /:id", () => {
    ...
    it("should return 404 if no genre with the give id exist", async () => {
  ...
  describe("POST /", () => {
    ...
    /** Testing the genre is saved in the database // The Happy Path | if not errror*/
    ...
    /** To make shure the genre is in the body of the response */
